...
import (
	...
	"github.com/BenWhiting/sqlboiler/v4/importers"

	"github.com/BenWhiting/sqlboiler/v4/drivers"
	"github.com/BenWhiting/sqlboiler/v4/drivers/mocks"
)
...
func testNew(t *testing.T, aliases Aliases) {
	...
	cmd = exec.Command("go", "mod", "init", "github.com/BenWhiting/sqlboiler-test")
	...
	cmd = exec.Command("go", "mod", "edit", fmt.Sprintf("-replace=github.com/BenWhiting/sqlboiler/v4=%s", filepath.Dir(string(goModFilePath))))
	cmd.Dir = state.Config.OutFolder
	cmd.Stderr = buf
